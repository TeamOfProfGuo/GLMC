...
data_folder = 'scratch/hy2611/dataset' # for greene,  '../dataset' for local
...
def get_dataset(args):
    ...
    if args.dataset == 'cifar10':
        ...
        # image_size:64 x 64
        data_folder = '/dataset/tinyimagenet'  # 更新路径
        trainset = datasets.ImageFolder(os.path.join(data_folder, 'train'), transform_train)
        testset = datasets.ImageFolder(os.path.join(data_folder, 'val'), transform_val)
        return trainset, testset
